            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="id_transaksi" name="id_transaksi" value="<?= $data_transaksi['id_transaksi']; ?>" readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?= $data_transaksi['tanggal']; ?>">
                            <small class="text-danger">
            ...
            <div class="col-sm-5">
              ...
              <small class="text-danger">
                <?php echo form_error('id_buku') ?>
                    ...
                    <div class="form-group row">
                        <label for="jumlah_buku" class="col-sm-2 col-formlabel">Jumlah Buku</label>
                        <div class="col-sm-5">
                            <input type="number" class="form-control" id="jumlah_buku" name="jumlah_buku" value="<?= $data_transaksi['jumlah_buku']; ?>">
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" class="form-control" id="total" name="total" value="<?= $data_transaksi['total']; ?>">
                            <small class="text-danger">
