            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="id_gaji" name="id_gaji" value="<?= set_value('id_gaji'); ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="id_guru2" name="id_guru2" value="<?= set_value('id_guru2'); ?>">
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        <label for="jmlh_gaji" class="col-sm-2 col-form-label">Jumlah Gaji</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="jmlh_gaji" name="jmlh_gaji" value=" <?= set_value('jmlh_gaji'); ?>">
                            <small class="text-danger">
