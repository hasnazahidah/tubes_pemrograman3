<div class="container pt-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb ">
            <li class="breadcrumb-item"><a>Akumlasi Gaji</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="id_penggajian" name="id_penggajian" value="<?= set_value('id_penggajian'); ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="id_gaji2" name="id_gaji2" value="<?= set_value('id_gaji2'); ?>">
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="id_pemasukan2" name="id_pemasukan2" value="<?= set_value('id_pemasukan2'); ?>">
                            <small class="text-danger">
                     ...
                     <div class="form-group row">
                        <label for="akumulasi_gaji" class="col-sm-2 col-form-label">Akumulasi Gaji</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="akumulasi_gaji" name="akumulasi_gaji" value=" <?= set_value('akumulasi_gaji'); ?>">
                            <small class="text-danger">
